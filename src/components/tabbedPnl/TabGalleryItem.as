package components.tabbedPnl {
	...
	public class TabGalleryItem extends Sprite {
		...
		public function TabGalleryItem(data:CoresetData, price:Number, picWidth:int, picHeight:int, imageLoadMethod:String = null, imageLoadParams:Object = null):void {
			_data = data;
			...
			priceField.htmlText = '<font face="CharterB" size="15" color="#9FAF00">' + price + ' руб.< / font >';
			priceField.x = picWidth - priceField.width - 5;
			priceField.y = picHeight - priceField.height - 5;
			addChild(priceField);
			priceField.filters = [new GlowFilter(0xffffff, 1, 12, 12, 7, 3)];
